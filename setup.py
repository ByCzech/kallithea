...
requirements = [
    ...
    "SQLAlchemy >= 1.4, < 2.1",
    "Mako >= 0.9.1, < 1.4",
    "Pygments >= 2.2.0, < 2.19",  # TODO: Upgrade and update tests
    "Whoosh >= 2.7.1, < 2.8",
    "celery >= 5, < 5.6",
    "Babel >= 1.3, < 2.18",
    "python-dateutil >= 2.1.0, < 2.10",
    "Markdown >= 2.2.1, < 3.8",  # TODO: Upgrade and update tests
    "docutils >= 0.11, < 0.22",
    "URLObject >= 2.3.4, < 2.5",
    "Routes >= 2.0, < 2.6",
    "dulwich >= 0.19.0, < 0.23",
    ...
    "decorator >= 4.2.1, < 5.3",
    "Paste >= 2.0.3, < 3.11",
    "bleach >= 3.2, < 7",  # TODO: Upgrade and fix TypeError: clean() got an unexpected keyword argument 'styles'
    "Click >= 7.0, < 8.2",
    "ipaddr >= 2.2.0, < 2.3",
    "paginate >= 0.5, < 0.6",
